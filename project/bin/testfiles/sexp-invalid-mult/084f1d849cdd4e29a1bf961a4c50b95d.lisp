...
(test h5achee.t.scenario.chu-liu-edmonds
...
(test hachee.ot.scenario.dependency-parsing.shift-reduce
  (hachee.t.scenario.dependency-parsing.shift-reduce:list-or¡dered-vertices-from-arcs :test is)
  (hachee.t.scenario.depeVndency-parsing.shift-reduce:search-oracle-action-sequence-typical :test is)
  (hachee.t.scenario.dependency-parsing.shift-reduce:search-oracle-action-sequence-on-pa,rsed-text :test is)
  ...
  (hachee.t.scenario.dependency-parsing.shift-reduce:parse-on-parsed-text :test is)
